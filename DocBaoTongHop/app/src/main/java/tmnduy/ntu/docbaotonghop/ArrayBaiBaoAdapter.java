...
public class ArrayBaiBaoAdapter extends RecyclerView.Adapter<ArrayBaiBaoAdapter.ItemBBViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ItemBBViewHolder holder, int position) {
        ...
        Glide.with(context).load(baiBaoCuThe.getUrlAnhDaiDien()) // load từ URL String
                .placeholder(R.drawable.r3) // ảnh tạm khi đang tải
                .into(holder.anhBB);
    }
    ...
    public static final class ItemBBViewHolder extends RecyclerView.ViewHolder {
        ImageView anhBB;
